...
import { ArrowRight, Calendar, ClipboardList, Timer, User } from "lucide-react";
...
export default function EmployeeDashboardPage() {
  ...
  return (
    <AppShell>
      ...
      <Link
        href="/timer"
        className="mb-8 flex items-center justify-between gap-4 rounded-2xl bg-zinc-950 px-5 py-4 text-white shadow-card"
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold">Window Timer</p>
            <p className="text-xs text-white/70">
              Tap car at window, tap again when they leave — SOS, cars, CPH
            </p>
          </div>
        </div>
        <span className="text-sm font-semibold">Start timing →</span>
      </Link>
