...
export function LiveSessionScreen({
  ...
  return (
    <div
      className={`flex min-h-dvh flex-col ${pull.isPull ? "bg-[#1a0709]" : "bg-[#0d0d0f]"}`}
    >
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-4 p-4">
        ...
        <button
          ...
          className={`flex w-full max-w-lg flex-col items-center justify-center rounded-3xl bg-cfa py-8 shadow-2xl shadow-red-600/30 active:bg-cfa-dark ${
